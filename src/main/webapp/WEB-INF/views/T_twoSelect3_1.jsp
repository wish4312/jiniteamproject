    ...
    <!-- Service Start -->
        ...
        <div class="container py-12">
            <div class="section-title text-center position-relative pb-4 mb-5 mx-auto" style="max-width: 900px;">
                ...
                <h1 class="mb-0">원데이 체험을 즐기실수 있는곳입니다!!</h1>
            </div>
            <div class="row g-5">
                <div class="col-lg-6 col-md-1 wow zoomIn" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: zoomIn;">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <h4 class="mb-2"></h4>
                        <p class="m-0"></p>
                       <img src= "${contextPath}/resources/bootstrap/img/m-img21.jpg" width="450x" height="420px" alt="Image">
                          <a class="btn btn-lg btn-primary rounded" title ="파주 치즈스쿨체험관" href="http://www.cheeseschool.kr/">
                ...
                <div class="col-lg-6 col-md-1 wow zoomIn" data-wow-delay="0.6s" style="visibility: visible; animation-delay: 0.6s; animation-name: zoomIn;">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                         ...
                         <h4 class="mb-2"></h4>
                        <p class="m-0"></p>
                       <img src= "${contextPath}/resources/bootstrap/img/m-img22.jpg" width="450x" height="420px" alt="Image">
                          <a class="btn btn-lg btn-primary rounded" title ="헤이리 도자기 체험마을" href="https://www.ceramicschool.co.kr/">
                            <i class="bi bi-arrow-right"></i>
                        </a>
                    </div>
                </div>
