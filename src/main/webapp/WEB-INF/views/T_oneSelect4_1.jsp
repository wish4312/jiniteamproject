    ...
    <!-- Service Start -->
        ...
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 900px;">
                <h3 class="fw-bold text-primary text-uppercase">테마파크(라이트)!!</h3>
                <h1 class="mb-0">#테마파크(어린이)#가족#엄마손꼭잡아야된다!!</h1>
            </div>
            <div class="row g-5">
                <div class="col-lg-6 ">
                    <div class="team-item bg-light rounded overflow-hidden">
                        <div class="team-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" style = "height : 490px" src="${contextPath}/resources/bootstrap/img/m-img10.jpg" alt="img">
                            <div class="team-social">
                               <a class="btn btn-lg btn-primary btn-lg-square rounded" title ="서울 어린이 대공원" href="https://www.sisul.or.kr/open_content/childrenpark/"><i class="bi bi-arrow-right"></i></a>
                ...
                <div class="col-lg-6 ">
                    <div class="team-item bg-light rounded overflow-hidden">
                        <div class="team-img position-relative overflow-hidden">
                            ...
                            <div class="team-social">
                           <a class="btn btn-lg btn-primary btn-lg-square rounded" title ="배다골 테마파크" href="http://baedagol.com/"><i class="bi bi-arrow-right"></i></a>
                            </div>
                        </div>
