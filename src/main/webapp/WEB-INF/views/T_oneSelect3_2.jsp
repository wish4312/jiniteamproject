    ...
    <!-- Service Start -->
        ...
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 1400px;">
                <h3 class="fw-bold text-primary text-uppercase">탈출!!</h3>
                <h1 class="mb-0">#탈출#돔황챠~#이거어떻게해야돼??</h1>
            </div>
            <div class="row g-5">
                <div class="col-lg-6 ">
                    <div class="team-item bg-light rounded overflow-hidden">
                        <div class="team-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" style = "height : 490px" src="${contextPath}/resources/bootstrap/img/m-img7.jpg" alt="img">
                            <div class="team-social">
                               <a class="btn btn-lg btn-primary btn-lg-square rounded" title ="스포츠안성점" href="https://www.smob.co.kr/branch"><i class="bi bi-arrow-right"></i></a>
                ...
                <div class="col-lg-6 ">
                    <div class="team-item bg-light rounded overflow-hidden">
                        <div class="team-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" style = "height : 490px" src="${contextPath}/resources/bootstrap/img/m-img8.jpg" alt="img">
                            <div class="team-social">
                           <a class="btn btn-lg btn-primary btn-lg-square rounded" title ="HIDE AND SEEK 홍대점" href="http://fuzzyline.co.kr"><i class="bi bi-arrow-right"></i></a>
                            </div>
                        </div>
