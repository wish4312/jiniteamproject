...
<!-- title end-->
 ...
 <!-- Full Screen Search Start -->
    ...
    <!-- Service Start -->
    <div class="container-fluid py-1 wow fadeInUp" data-wow-delay="0.0s" style="visibility: visible; animation-delay: 0.0s; animation-name: fadeInUp;">
            ...
            <div class="row g-5">
                <div class="col-lg-6 col-md-1 wow zoomIn" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: zoomIn;">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        ...
                        <h4 class="mb-2"></h4>
                        <p class="m-0"></p>
                       <img src= "${contextPath}/resources/bootstrap/img/k-img10.jpg" width="400x" height="300px" alt="Image">
                          <a class="btn btn-lg btn-primary rounded" href="${contextPath}/board/T_oneSelect1">
                ...
                <div class="col-lg-6 col-md-1 wow zoomIn" data-wow-delay="0.6s" style="visibility: visible; animation-delay: 0.6s; animation-name: zoomIn;">
                    <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                         ...
                         <h4 class="mb-2"></h4>
                        <p class="m-0"></p>
                       <img src= "${contextPath}/resources/bootstrap/img/k-img11.jpg" width="400x" height="300px" alt="Image">
                          <a href="${contextPath}/board/T_twoSelect1">
                            <i class="bi bi-arrow-right"></i>
                        </a>
                    </div>
                </div>
