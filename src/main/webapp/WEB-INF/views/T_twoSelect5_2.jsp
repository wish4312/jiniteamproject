    ...
    <!-- Service Start -->
        ...
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 900px;">
                <h3 class="fw-bold text-primary text-uppercase">유람선!!</h3>
                <h1 class="mb-0">#유람선#타이타닉#재에엑~</h1>
            </div>
            <div class="row g-5">
                <div class="col-lg-6" >
                    <div class="team-item bg-light rounded overflow-hidden">
                        <div class="team-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" style = "height : 490px" src="${contextPath}/resources/bootstrap/img/m-img31.jpg" alt="img">
                            <div class="team-social">
                               <a class="btn btn-lg btn-primary btn-lg-square rounded" title ="여의도 이크루즈" href="https://blog.naver.com/ecruise00"><i class="bi bi-arrow-right"></i></a>
                ...
                <div class="col-lg-6" >
                    <div class="team-item bg-light rounded overflow-hidden">
                        <div class="team-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" style = "height : 490px" src="${contextPath}/resources/bootstrap/img/m-img32.jpg" alt="img">
                            <div class="team-social">
                           <a class="btn btn-lg btn-primary btn-lg-square rounded" title ="현대 유람선" href="http://www.aracruise.co.kr/"><i class="bi bi-arrow-right"></i></a>
                            </div>
                        </div>
