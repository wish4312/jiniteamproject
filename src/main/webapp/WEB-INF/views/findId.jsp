 ...
 <div>
   <!-- Main content -->
    <section class="content container-fluid">
      <form role="form" name="f" method="post" action="${contextPath}/board/changID" onsubmit="return validate();">
         <div class="box-body">
        <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s" style="visibility: visible; animation-delay: 0.6s; animation-name: zoomIn;">
            ...
            <div class="box-group">
               <label>이   름</label>
               <input type='text' id='m_name' name='m_name' onclick="name_click();" style="width:28%;margin-left:80px;border:none;">
            </div>
