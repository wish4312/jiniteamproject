    ...
    <!-- Service Start -->
        ...
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-4 mb-5 mx-auto" style="max-width: 1400px;">
                <h3 class="fw-bold text-primary text-uppercase">승마!!</h3>
                <h1 class="mb-0">#승마#히이이이잉~#달려달려~</h1>
            </div>
            <div class="row g-5">
                <div class="col-lg-6">
                    <div class="team-item bg-light rounded overflow-hidden">
                        <div class="team-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" style = "height:490px" src="${contextPath}/resources/bootstrap/img/m-img1.jpg" alt="img">
                            <div class="team-social">
                               <a class="btn btn-lg btn-primary btn-lg-square rounded" title = "미사리 승마공원" href="http://www.misari-riding.co.kr/"><i class="bi bi-arrow-right"></i></a>
                ...
                <div class="col-lg-6">
                    <div class="team-item bg-light rounded overflow-hidden">
                        <div class="team-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" style = "height : 490px" src="${contextPath}/resources/bootstrap/img/m-img2.jpg" alt="img">
                            <div class="team-social">
                           <a class="btn btn-lg btn-primary btn-lg-square rounded" title = "유니콘 승마클럽" href="http://유니콘승마클럽.com"><i class="bi bi-arrow-right"></i></a>
                            </div>
                        </div>
